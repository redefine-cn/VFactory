...
#define kTimeKey @"CommonRefreshHeaderView"

#import "CommonRefreshHeaderView.h"

@interface CommonRefreshHeaderView()
// 最后的更新时间
@property (nonatomic, strong) NSDate *lastUpdateTime;
@end

@implementation CommonRefreshHeaderView

+ (id)header
{
    return [[CommonRefreshHeaderView alloc] init];
}
