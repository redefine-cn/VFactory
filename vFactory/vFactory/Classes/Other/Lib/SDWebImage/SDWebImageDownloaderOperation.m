...
//Executing Finished 与父类名字重合 ，改为childExecuting、childFinished
@property (assign, nonatomic, getter = isExecuting) BOOL childExecuting;//Executing 与父类名字重合
@property (assign, nonatomic, getter = isFinished) BOOL childFinished;
...
- (void)setFinished:(BOOL)finished
{
    ...
    _childFinished = finished;  //self.childFinished,不能用，造成死循环
